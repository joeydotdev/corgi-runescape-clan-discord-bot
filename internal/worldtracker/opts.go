...
type WorldTrackerOpts struct {
	Threshold int    `short:"t" long:"threshold" description:"The threshold for the number of players to trigger a world tracker spike event" default:"25" required:"true"`
